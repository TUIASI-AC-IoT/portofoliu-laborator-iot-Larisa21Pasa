...
#define CONFIG_PEER_IP_ADDR "192.168.89.30"
#define  CONFIG_PEER_PORT 10003
...
#define GPIO_OUTPUT_PIN_SEL_2 (1ULL<<GPIO_OUTPUT_IO)
...
void control_led(int state)
{
    ...
    gpio_set_level(GPIO_OUTPUT_IO, state);
}
...
void add_mdns_services()
{
    ...
    mdns_service_instance_name_set("_http", "_tcp", "pasa's ESP32 Web Server");
...
void app_main(void)
{
    ...
    while(1){
    resolve_mdns_host(HOSTNAME_RARES);
    resolve_mdns_host(HOSTNAME_DIANA);
